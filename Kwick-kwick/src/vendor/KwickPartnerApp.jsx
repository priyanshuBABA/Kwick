...
function Landing({ onSelect, onOpenPortal, onLogout }) {
...
export default function KwickPartnerApp() {
  ...
  return showPortal ? <Portal category={category} onBack={handleBack} onLogin={handleLogin} /> : <Landing onSelect={handleSelect} onOpenPortal={handleSelect} onLogout={handleLogout} />;
}
