  ...
  const handlePayment = () => {
    ...
    window.setTimeout(() => {
      placeOrder({
        ...
        service: cart[0]?.service || cart[0]?.category || 'General',
      });
      clearCart();
