      ...
      async (pos) => {
        ...
        try {
          ...
          const label =
            ...
            a.city || data.display_name?.split(",")[0] || "Current Location";
          const area = a.city || a.town || a.county || "";
          setDropLocation(area && area !== label ? `${label}, ${area}` : label);
        } catch {
          setDropLocation(`Lat ${latitude.toFixed(3)}, Lng ${longitude.toFixed(3)}`);
        }
